...
import com.example.tpobligatorio3.databinding.FragmentGalleryBinding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        mv.getMLista().observe(getViewLifecycleOwner(), new Observer<ArrayList<Producto>>() {
            ...
            public void onChanged(ArrayList<Producto> productos) {
                ListaProductosAdapter la = new ListaProductosAdapter((ArrayList<Producto>) productos,getLayoutInflater(),getContext());
